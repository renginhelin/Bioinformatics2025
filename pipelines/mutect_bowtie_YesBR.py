...
tumor_bam = BamReader("/home/rengin/cosap_data/unprocessed_tumor_bowtie.bam")
normal_bam = BamReader("/home/rengin/cosap_data/unprocessed_normal_bowtie.bam")
...
caller = VariantCaller(library="mutect", normal_sample=basecal_normal, tumor_sample=basecal_tumor)
